...
export default function BattleCard({ node, enemyTeam, trainerSprite, playerRoster, character, damageMultiplier = 2, onBattleEnd, onDefeat, onRestart, onMainMenu, seedCode, cashEarned = 0, speedCash = 0, badges = [], badgesEarned = 0 }) {
  ...
  const defeatOverlay = battleResult === 'loss' ? (
    <DefeatScreen roster={battleRoster} onRestart={onRestart} onMainMenu={onMainMenu} seedCode={seedCode} cashEarned={cashEarned} speedCash={speedCash} badges={badges} badgesEarned={badgesEarned} />
  ) : null
...
function DefeatScreen({ roster, onRestart, onMainMenu, seedCode, cashEarned = 0, speedCash = 0, badges = [], badgesEarned = 0 }) {
  return (
    <RunEndScreen
      roster={roster}
      title="Defeated..."
