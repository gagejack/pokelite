...
- `src/game/pokemon.js` reads the local files first and falls back to pokeapi.co for uncovered species; evolution chains are pruned to level-up branches only
